...
Wrapper contract that converts between ERC7984 confidential tokens and standard ERC20 tokens
...
## Contract: ConfidentialToERC20Wrapper
...
```bash
cd examples/erc7984-to-erc20-wrapper
npm install
npm run compile
npm run test
```
