# Anti Pattern View Functions

> **Category:** anti-patterns
> **Difficulty:** beginner

Demonstrates why view functions cannot return decrypted encrypted values

## Overview

IMPORTANT: This shows what NOT to do!
...
```bash
cd examples/anti-pattern-view-functions
npm install
npm run compile
npm run test
```
...
- Check other examples in the Anti-Patterns category
