...
Collection of common FHEVM mistakes and how to avoid them

## Overview

This contract shows multiple anti-patterns in one place
...
```bash
cd examples/anti-pattern-common-mistakes
npm install
npm run compile
npm run test
```
