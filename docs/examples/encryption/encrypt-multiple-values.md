...
Demonstrates how to encrypt and handle multiple values in a single transaction
...
```bash
cd examples/encrypt-multiple-values
npm install
npm run compile
npm run test
```
...
- Check other examples in the Encryption category
