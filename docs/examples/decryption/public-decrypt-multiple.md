...
Demonstrates public decryption of multiple values simultaneously
...
## Contract: PublicDecryptMultiple
...
```bash
cd examples/public-decrypt-multiple
npm install
npm run compile
npm run test
```
...
- Check other examples in the Decryption category
